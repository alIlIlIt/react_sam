...
const siteText = [
    {
        text:["make","2차포트폴리오","KimHyeonSoo"],
        title:"웹표준을 준수한 웹사이트",
        code:"/",
        view:"/",
        info:["site coding","production perriod : 5day","use stack : HTML5 / CSS3 / SCSS"],
    },{
        text:["make","팀프로젝트","E.O.F"],
        title:"팀의 한작품",
        code:"/",
        view:"/",
        info:["site coding","production perriod : 10day","use stack : HTML5 / CSS3 / SCSS"],
    },{
        text:["make","1차 포트폴리오","김현수"],
        title:"나의 첫작품",
        code:"/",
        view:"/",
        info:["site coding","production perriod : 5day","use stack : HTML5 / CSS3 / SCSS"],
